pub mod constant {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_vpi_const_type(self) -> i64 {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_vpi_const_type(&mut self, value: i64)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 50] = [
      ...
      ::capnp::word(81, 77, 0, 0, 144, 77, 0, 0),
      ...
      ::capnp::word(112, 58, 67, 111, 110, 115, 116, 97),
    ...
    pub const TYPE_ID: u64 = 0xf3a7_6dcc_8708_b0d6;
  }
}
