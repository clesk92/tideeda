pub mod immediatecover {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 113] = [
      ...
      ::capnp::word(43, 65, 0, 0, 225, 65, 0, 0),
      ...
      ::capnp::word(97, 116, 101, 99, 111, 118, 101, 114),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[0,5,3,4,1,2];
    pub const TYPE_ID: u64 = 0xe56c_d4e3_7901_ac2e;
  }
}
