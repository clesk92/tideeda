pub mod classvar {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_classobj(&mut self, value: u64)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 66] = [
      ...
      ::capnp::word(202, 134, 0, 0, 34, 135, 0, 0),
      ...
      ::capnp::word(112, 58, 67, 108, 97, 115, 115, 118),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(99, 108, 97, 115, 115, 111, 98, 106),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub const TYPE_ID: u64 = 0xc88a_3249_d02b_b59c;
  }
}
