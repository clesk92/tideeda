pub mod delaycontrol {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 80] = [
      ...
      ::capnp::word(234, 41, 0, 0, 101, 42, 0, 0),
      ...
      ::capnp::word(112, 58, 68, 101, 108, 97, 121, 99),
      ::capnp::word(111, 110, 116, 114, 111, 108, 0, 0),
    ...
    pub const TYPE_ID: u64 = 0xd485_855f_0f73_c00e;
  }
}
