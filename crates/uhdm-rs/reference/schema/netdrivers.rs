pub mod netdrivers {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 34] = [
      ...
      ::capnp::word(112, 58, 78, 101, 116, 100, 114, 105),
    ...
    pub const TYPE_ID: u64 = 0xed57_ece5_0fb8_0495;
  }
}
