pub mod always {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_base(self) -> ::capnp::Result<crate::uhdm_capnp::processstmt::Reader<'a>> {
    ...
    #[inline]
    pub fn get_vpi_always_type(self) -> i64 {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_base(self) -> ::capnp::Result<crate::uhdm_capnp::processstmt::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_base(&mut self, value: crate::uhdm_capnp::processstmt::Reader<'_>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
    }
    #[inline]
    pub fn init_base(self, ) -> crate::uhdm_capnp::processstmt::Builder<'a> {
    ...
    #[inline]
    pub fn set_vpi_always_type(&mut self, value: i64)  {
  ...
  impl Pipeline  {
    pub fn get_base(&self) -> crate::uhdm_capnp::processstmt::Pipeline {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 50] = [
      ...
      ::capnp::word(235, 40, 0, 0, 48, 41, 0, 0),
      ...
      ::capnp::word(112, 58, 65, 108, 119, 97, 121, 115),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      ::capnp::word(52, 177, 116, 158, 220, 239, 97, 173),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(16, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 65, 108, 119, 97, 121),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        0 => <crate::uhdm_capnp::processstmt::Owned as ::capnp::introspect::Introspect>::introspect(),
    ...
    pub const TYPE_ID: u64 = 0xb319_fe12_59f0_29dc;
  }
}
