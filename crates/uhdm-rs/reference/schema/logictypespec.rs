pub mod logictypespec {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_elemtypespec(self) -> u64 {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_elemtypespec(&mut self, value: u64)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 165] = [
      ...
      ::capnp::word(65, 152, 0, 0, 82, 153, 0, 0),
      ...
      ::capnp::word(112, 58, 76, 111, 103, 105, 99, 116),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[0,2,6,4,3,8,5,7,1];
    pub const TYPE_ID: u64 = 0xe3ed_1db0_d929_154e;
  }
}
