pub mod processstmt {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 85] = [
      ...
      ::capnp::word(111, 40, 0, 0, 233, 40, 0, 0),
      ...
      ::capnp::word(112, 58, 80, 114, 111, 99, 101, 115),
      ::capnp::word(115, 115, 116, 109, 116, 0, 0, 0),
    ...
    pub const TYPE_ID: u64 = 0xad61_efdc_9e74_b134;
  }
}
