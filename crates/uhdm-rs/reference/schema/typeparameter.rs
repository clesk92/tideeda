pub mod typeparameter {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_vpi_local_param(self) -> bool {
    ...
    #[inline]
    pub fn get_vpi_imported(self) -> u64 {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_vpi_local_param(&mut self, value: bool)  {
    ...
    #[inline]
    pub fn set_vpi_imported(&mut self, value: u64)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 113] = [
      ...
      ::capnp::word(224, 156, 0, 0, 150, 157, 0, 0),
      ...
      ::capnp::word(112, 58, 84, 121, 112, 101, 112, 97),
      ...
      ::capnp::word(80, 97, 114, 97, 109, 0, 0, 0),
      ::capnp::word(1, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 73, 109, 112, 111, 114),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[0,4,3,2,5,1];
    pub const TYPE_ID: u64 = 0x801b_873b_35e2_5229;
  }
}
