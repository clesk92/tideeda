pub mod contassign {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_contassignbits(self) -> ::capnp::Result<::capnp::primitive_list::Reader<'a,u64>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(4), ::core::option::Option::None)
    }
    #[inline]
    pub fn has_contassignbits(&self) -> bool {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_contassignbits(self) -> ::capnp::Result<::capnp::primitive_list::Builder<'a,u64>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(4), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_contassignbits(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::primitive_list::Owned<u64>>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(4), value, false)
    }
    #[inline]
    pub fn init_contassignbits(self, size: u32) -> ::capnp::primitive_list::Builder<'a,u64> {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 164] = [
      ...
      ::capnp::word(44, 100, 0, 0, 46, 101, 0, 0),
      ...
      ::capnp::word(103, 110, 98, 105, 116, 115, 0, 0),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[0,8,5,7,6,1,2,3,4];
    pub const TYPE_ID: u64 = 0x9227_d3f1_5c9c_c33f;
  }
}
