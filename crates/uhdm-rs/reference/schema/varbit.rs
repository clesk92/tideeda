pub mod varbit {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_exprindexes(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,crate::uhdm_capnp::obj_index_type::Owned>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(2), ::core::option::Option::None)
    }
    #[inline]
    pub fn has_exprindexes(&self) -> bool {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_exprindexes(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,crate::uhdm_capnp::obj_index_type::Owned>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(2), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_exprindexes(&mut self, value: ::capnp::struct_list::Reader<'_,crate::uhdm_capnp::obj_index_type::Owned>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(2), value, false)
    }
    #[inline]
    pub fn init_exprindexes(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::uhdm_capnp::obj_index_type::Owned> {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 87] = [
      ...
      ::capnp::word(42, 96, 0, 0, 182, 96, 0, 0),
      ...
      ::capnp::word(112, 58, 86, 97, 114, 98, 105, 116),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(101, 120, 112, 114, 105, 110, 100, 101),
      ::capnp::word(120, 101, 115, 0, 0, 0, 0, 0),
    ...
    pub const TYPE_ID: u64 = 0xc0db_f31c_4fe8_4a9f;
  }
}
