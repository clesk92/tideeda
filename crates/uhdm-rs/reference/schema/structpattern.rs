pub mod structpattern {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_pattern(self) -> ::capnp::Result<crate::uhdm_capnp::obj_index_type::Reader<'a>> {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_pattern(self) -> ::capnp::Result<crate::uhdm_capnp::obj_index_type::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(1), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_pattern(&mut self, value: crate::uhdm_capnp::obj_index_type::Reader<'_>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
    }
    #[inline]
    pub fn init_pattern(self, ) -> crate::uhdm_capnp::obj_index_type::Builder<'a> {
  ...
  impl Pipeline  {
    ...
    pub fn get_pattern(&self) -> crate::uhdm_capnp::obj_index_type::Pipeline {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 64] = [
      ...
      ::capnp::word(111, 68, 0, 0, 203, 68, 0, 0),
      ...
      ::capnp::word(112, 97, 116, 116, 101, 114, 110, 0),
    ...
    pub const TYPE_ID: u64 = 0xcb2e_cc4e_6f8f_1692;
  }
}
