pub mod contassignbit {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_vpi_offset(self) -> i64 {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_vpi_offset(&mut self, value: i64)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 160] = [
      ...
      ::capnp::word(48, 101, 0, 0, 41, 102, 0, 0),
      ...
      ::capnp::word(112, 58, 67, 111, 110, 116, 97, 115),
      ::capnp::word(115, 105, 103, 110, 98, 105, 116, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 79, 102, 102, 115, 101),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[0,6,8,7,2,1,3,4,5];
    pub const TYPE_ID: u64 = 0xe0fa_450b_df81_e42a;
  }
}
