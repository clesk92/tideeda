pub mod ifelse {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_vpi_qualifier(self) -> i64 {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_vpi_qualifier(&mut self, value: i64)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 97] = [
      ...
      ::capnp::word(159, 53, 0, 0, 66, 54, 0, 0),
      ...
      ::capnp::word(112, 58, 73, 102, 101, 108, 115, 101),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 81, 117, 97, 108, 105),
      ::capnp::word(102, 105, 101, 114, 0, 0, 0, 0),
    ...
    pub const TYPE_ID: u64 = 0xc2b6_8ed4_02c9_d631;
  }
}
