pub mod interfacetypespec {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_vpi_is_mod_port(self) -> bool {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_vpi_is_mod_port(&mut self, value: bool)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 87] = [
      ...
      ::capnp::word(87, 156, 0, 0, 222, 156, 0, 0),
      ...
      ::capnp::word(97, 99, 101, 116, 121, 112, 101, 115),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 73, 115, 77, 111, 100),
    ...
    pub const TYPE_ID: u64 = 0x926c_5411_42ca_adae;
  }
}
