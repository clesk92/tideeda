pub mod unsupportedexpr {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 35] = [
      ...
      ::capnp::word(205, 68, 0, 0, 248, 68, 0, 0),
      ...
      ::capnp::word(112, 58, 85, 110, 115, 117, 112, 112),
      ::capnp::word(111, 114, 116, 101, 100, 101, 120, 112),
    ...
    pub const TYPE_ID: u64 = 0xc955_b0de_03ee_e29d;
  }
}
