pub mod chandletypespec {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 35] = [
      ...
      ::capnp::word(228, 150, 0, 0, 19, 151, 0, 0),
      ...
      ::capnp::word(112, 58, 67, 104, 97, 110, 100, 108),
      ::capnp::word(101, 116, 121, 112, 101, 115, 112, 101),
    ...
    pub const TYPE_ID: u64 = 0x9361_5dd8_e590_81be;
  }
}
