pub mod structvar {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 123] = [
      ...
      ::capnp::word(139, 93, 0, 0, 87, 94, 0, 0),
      ...
      ::capnp::word(112, 58, 83, 116, 114, 117, 99, 116),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[0,5,3,4,2,1];
    pub const TYPE_ID: u64 = 0xa52a_1bfd_03b5_7463;
  }
}
