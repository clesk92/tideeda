pub mod checkerport {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_property(&mut self, value: u64)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 86] = [
      ...
      ::capnp::word(75, 104, 0, 0, 195, 104, 0, 0),
      ...
      ::capnp::word(114, 112, 111, 114, 116, 0, 0, 0),
    ...
    pub const TYPE_ID: u64 = 0xa854_dd75_4d59_83a0;
  }
}
