pub mod packedarraytypespec {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 150] = [
      ...
      ::capnp::word(84, 153, 0, 0, 85, 154, 0, 0),
      ...
      ::capnp::word(97, 114, 114, 97, 121, 116, 121, 112),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[0,5,3,2,7,4,6,1];
    pub const TYPE_ID: u64 = 0xef33_093b_20c9_310f;
  }
}
