pub mod typespecmember {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_vpi_rand_type(self) -> bool {
    ...
    #[inline]
    pub fn get_defaultvalue(self) -> ::capnp::Result<crate::uhdm_capnp::obj_index_type::Reader<'a>> {
    ...
    #[inline]
    pub fn get_vpi_ref_file(self) -> u64 {
      self.reader.get_data_field::<u64>(2)
    }
    #[inline]
    pub fn get_vpi_ref_line_no(self) -> i64 {
      self.reader.get_data_field::<i64>(3)
    }
    #[inline]
    pub fn get_vpi_ref_column_no(self) -> i64 {
      self.reader.get_data_field::<i64>(4)
    }
    #[inline]
    pub fn get_vpi_ref_end_line_no(self) -> i64 {
      self.reader.get_data_field::<i64>(5)
    }
    #[inline]
    pub fn get_vpi_ref_end_column_no(self) -> i64 {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_vpi_rand_type(&mut self, value: bool)  {
    ...
    #[inline]
    pub fn get_defaultvalue(self) -> ::capnp::Result<crate::uhdm_capnp::obj_index_type::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(2), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_defaultvalue(&mut self, value: crate::uhdm_capnp::obj_index_type::Reader<'_>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(2), value, false)
    }
    #[inline]
    pub fn init_defaultvalue(self, ) -> crate::uhdm_capnp::obj_index_type::Builder<'a> {
    ...
    #[inline]
    pub fn set_vpi_ref_file(&mut self, value: u64)  {
    ...
    #[inline]
    pub fn set_vpi_ref_line_no(&mut self, value: i64)  {
    ...
    #[inline]
    pub fn set_vpi_ref_column_no(&mut self, value: i64)  {
    ...
    #[inline]
    pub fn set_vpi_ref_end_line_no(&mut self, value: i64)  {
    ...
    #[inline]
    pub fn set_vpi_ref_end_column_no(&mut self, value: i64)  {
  ...
  impl Pipeline  {
    ...
    pub fn get_defaultvalue(&self) -> crate::uhdm_capnp::obj_index_type::Pipeline {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 179] = [
      ...
      ::capnp::word(152, 157, 0, 0, 193, 158, 0, 0),
      ...
      ::capnp::word(101, 99, 109, 101, 109, 98, 101, 114),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(100, 101, 102, 97, 117, 108, 116, 118),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 82, 101, 102, 70, 105),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 82, 101, 102, 76, 105),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 82, 101, 102, 67, 111),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 82, 101, 102, 69, 110),
      ::capnp::word(100, 76, 105, 110, 101, 78, 111, 0),
      ::capnp::word(5, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 82, 101, 102, 69, 110),
      ::capnp::word(100, 67, 111, 108, 117, 109, 110, 78),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[0,4,3,1,2,7,9,8,5,6];
    pub const TYPE_ID: u64 = 0xf15c_4fe4_296c_1aae;
  }
}
