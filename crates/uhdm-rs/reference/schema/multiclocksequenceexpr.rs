pub mod multiclocksequenceexpr {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_clockedseqs(self) -> ::capnp::Result<::capnp::primitive_list::Reader<'a,u64>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(1), ::core::option::Option::None)
    }
    #[inline]
    pub fn has_clockedseqs(&self) -> bool {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_clockedseqs(self) -> ::capnp::Result<::capnp::primitive_list::Builder<'a,u64>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(1), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_clockedseqs(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::primitive_list::Owned<u64>>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
    }
    #[inline]
    pub fn init_clockedseqs(self, size: u32) -> ::capnp::primitive_list::Builder<'a,u64> {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 56] = [
      ...
      ::capnp::word(64, 76, 0, 0, 146, 76, 0, 0),
      ...
      ::capnp::word(112, 58, 77, 117, 108, 116, 105, 99),
      ::capnp::word(108, 111, 99, 107, 115, 101, 113, 117),
      ::capnp::word(101, 110, 99, 101, 101, 120, 112, 114),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(99, 108, 111, 99, 107, 101, 100, 115),
      ::capnp::word(101, 113, 115, 0, 0, 0, 0, 0),
    ...
    pub const TYPE_ID: u64 = 0x89c3_9d3b_1f99_843f;
  }
}
