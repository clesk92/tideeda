pub mod refobj {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 129] = [
      ...
      ::capnp::word(195, 78, 0, 0, 141, 79, 0, 0),
      ...
      ::capnp::word(112, 58, 82, 101, 102, 111, 98, 106),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[5,0,3,2,4,1,6];
    pub const TYPE_ID: u64 = 0x9a56_f7b9_3f15_9d0f;
  }
}
