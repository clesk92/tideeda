pub mod includefileinfo {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_vpi_included_file(self) -> u64 {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_vpi_included_file(&mut self, value: u64)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 51] = [
      ...
      ::capnp::word(69, 69, 0, 0, 142, 69, 0, 0),
      ...
      ::capnp::word(112, 58, 73, 110, 99, 108, 117, 100),
      ::capnp::word(101, 102, 105, 108, 101, 105, 110, 102),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 73, 110, 99, 108, 117),
      ::capnp::word(100, 101, 100, 70, 105, 108, 101, 0),
    ...
    pub const TYPE_ID: u64 = 0xec15_8bd3_ad24_a2b4;
  }
}
