pub mod continuestmt {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 34] = [
      ...
      ::capnp::word(179, 51, 0, 0, 225, 51, 0, 0),
      ...
      ::capnp::word(112, 58, 67, 111, 110, 116, 105, 110),
      ::capnp::word(117, 101, 115, 116, 109, 116, 0, 0),
    ...
    pub const TYPE_ID: u64 = 0xb74e_b954_f5e1_731c;
  }
}
