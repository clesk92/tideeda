pub mod sysfunccall {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_vpi_func_type(self) -> i64 {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_vpi_func_type(&mut self, value: i64)  {
    ...
    #[inline]
    pub fn set_usersystf(&mut self, value: u64)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 82] = [
      ...
      ::capnp::word(247, 160, 0, 0, 108, 161, 0, 0),
      ...
      ::capnp::word(112, 58, 83, 121, 115, 102, 117, 110),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 70, 117, 110, 99, 84),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(117, 115, 101, 114, 115, 121, 115, 116),
    ...
    pub const TYPE_ID: u64 = 0xac31_527d_873c_ec03;
  }
}
