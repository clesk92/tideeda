pub mod function {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_base(self) -> ::capnp::Result<crate::uhdm_capnp::taskfunc::Reader<'a>> {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_base(self) -> ::capnp::Result<crate::uhdm_capnp::taskfunc::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_base(&mut self, value: crate::uhdm_capnp::taskfunc::Reader<'_>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
    }
    #[inline]
    pub fn init_base(self, ) -> crate::uhdm_capnp::taskfunc::Builder<'a> {
  ...
  impl Pipeline  {
    pub fn get_base(&self) -> crate::uhdm_capnp::taskfunc::Pipeline {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 81] = [
      ...
      ::capnp::word(195, 98, 0, 0, 50, 99, 0, 0),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        0 => <crate::uhdm_capnp::taskfunc::Owned as ::capnp::introspect::Introspect>::introspect(),
    ...
    pub const TYPE_ID: u64 = 0xd0a8_f41c_104e_bf1c;
  }
}
