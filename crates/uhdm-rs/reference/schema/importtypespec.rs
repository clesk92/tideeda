pub mod importtypespec {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_item(&mut self, value: u64)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 50] = [
      ...
      ::capnp::word(99, 165, 0, 0, 165, 165, 0, 0),
      ...
      ::capnp::word(112, 58, 73, 109, 112, 111, 114, 116),
    ...
    pub const TYPE_ID: u64 = 0xdb80_2a95_c832_3dc7;
  }
}
