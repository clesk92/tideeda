pub mod expr {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_vpi_decompile(self) -> u64 {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_vpi_decompile(&mut self, value: u64)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 96] = [
      ...
      ::capnp::word(227, 65, 0, 0, 106, 66, 0, 0),
      ...
      ::capnp::word(112, 58, 69, 120, 112, 114, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 68, 101, 99, 111, 109),
      ::capnp::word(112, 105, 108, 101, 0, 0, 0, 0),
    ...
    pub const TYPE_ID: u64 = 0xf2d0_481a_d9ac_65b1;
  }
}
