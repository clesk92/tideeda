pub mod package {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_vpi_unit(&mut self, value: bool)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 65] = [
      ...
      ::capnp::word(114, 142, 0, 0, 201, 142, 0, 0),
      ...
      ::capnp::word(112, 58, 80, 97, 99, 107, 97, 103),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 85, 110, 105, 116, 0),
      ::capnp::word(1, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub const TYPE_ID: u64 = 0xdfd5_88e2_6996_d1a6;
  }
}
