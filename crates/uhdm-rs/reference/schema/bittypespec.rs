pub mod bittypespec {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_bittypespec(self) -> u64 {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_bittypespec(&mut self, value: u64)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 165] = [
      ...
      ::capnp::word(74, 159, 0, 0, 83, 160, 0, 0),
      ...
      ::capnp::word(112, 58, 66, 105, 116, 116, 121, 112),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(98, 105, 116, 116, 121, 112, 101, 115),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[0,2,4,3,8,5,6,7,1];
    pub const TYPE_ID: u64 = 0xbdbd_c981_e984_8a7a;
  }
}
