pub mod attribute {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_vpi_def_attribute(self) -> bool {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_vpi_def_attribute(&mut self, value: bool)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 113] = [
      ...
      ::capnp::word(17, 38, 0, 0, 182, 38, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 68, 101, 102, 65, 116),
      ::capnp::word(116, 114, 105, 98, 117, 116, 101, 0),
      ::capnp::word(1, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub const TYPE_ID: u64 = 0xf9dc_2ad7_4291_0c71;
  }
}
