pub mod cover {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_vpi_is_cover_sequence(self) -> bool {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_vpi_is_cover_sequence(&mut self, value: bool)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 66] = [
      ...
      ::capnp::word(105, 62, 0, 0, 215, 62, 0, 0),
      ...
      ::capnp::word(112, 58, 67, 111, 118, 101, 114, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 73, 115, 67, 111, 118),
      ::capnp::word(101, 114, 83, 101, 113, 117, 101, 110),
    ...
    pub const TYPE_ID: u64 = 0xe612_7561_d1fa_a336;
  }
}
