pub mod propformaldecl {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 97] = [
      ...
      ::capnp::word(1, 72, 0, 0, 151, 72, 0, 0),
      ...
      ::capnp::word(112, 58, 80, 114, 111, 112, 102, 111),
      ::capnp::word(114, 109, 97, 108, 100, 101, 99, 108),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub const TYPE_ID: u64 = 0xa791_032c_e002_03ca;
  }
}
