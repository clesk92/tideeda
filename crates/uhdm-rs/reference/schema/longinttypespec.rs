pub mod longinttypespec {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 51] = [
      ...
      ::capnp::word(61, 149, 0, 0, 131, 149, 0, 0),
      ...
      ::capnp::word(112, 58, 76, 111, 110, 103, 105, 110),
      ::capnp::word(116, 116, 121, 112, 101, 115, 112, 101),
    ...
    pub const TYPE_ID: u64 = 0xd274_bd5c_179c_9a6d;
  }
}
