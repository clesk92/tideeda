pub mod structtypespec {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_members(self) -> ::capnp::Result<::capnp::primitive_list::Reader<'a,u64>> {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_members(self) -> ::capnp::Result<::capnp::primitive_list::Builder<'a,u64>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(1), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_members(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::primitive_list::Owned<u64>>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
    }
    #[inline]
    pub fn init_members(self, size: u32) -> ::capnp::primitive_list::Builder<'a,u64> {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 86] = [
      ...
      ::capnp::word(69, 151, 0, 0, 197, 151, 0, 0),
    ...
    pub const TYPE_ID: u64 = 0xd527_7942_04a0_bfac;
  }
}
