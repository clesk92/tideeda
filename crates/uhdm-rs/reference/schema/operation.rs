pub mod operation {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_base(self) -> ::capnp::Result<crate::uhdm_capnp::expr::Reader<'a>> {
    ...
    #[inline]
    pub fn get_vpi_reordered(self) -> bool {
      self.reader.get_bool_field(64)
    }
    #[inline]
    pub fn get_vpi_flattened(self) -> bool {
      self.reader.get_bool_field(65)
    }
    #[inline]
    pub fn get_vpi_op_strong(self) -> bool {
      self.reader.get_bool_field(66)
    }
    #[inline]
    pub fn get_operands(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,crate::uhdm_capnp::obj_index_type::Owned>> {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_base(self) -> ::capnp::Result<crate::uhdm_capnp::expr::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_base(&mut self, value: crate::uhdm_capnp::expr::Reader<'_>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
    }
    #[inline]
    pub fn init_base(self, ) -> crate::uhdm_capnp::expr::Builder<'a> {
    ...
    #[inline]
    pub fn set_vpi_reordered(&mut self, value: bool)  {
    ...
    #[inline]
    pub fn set_vpi_flattened(&mut self, value: bool)  {
    ...
    #[inline]
    pub fn set_vpi_op_strong(&mut self, value: bool)  {
      self.builder.set_bool_field(66, value);
    }
    #[inline]
    pub fn get_operands(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,crate::uhdm_capnp::obj_index_type::Owned>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(1), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_operands(&mut self, value: ::capnp::struct_list::Reader<'_,crate::uhdm_capnp::obj_index_type::Owned>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
    }
    #[inline]
    pub fn init_operands(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::uhdm_capnp::obj_index_type::Owned> {
  ...
  impl Pipeline  {
    pub fn get_base(&self) -> crate::uhdm_capnp::expr::Pipeline {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 138] = [
      ...
      ::capnp::word(243, 77, 0, 0, 193, 78, 0, 0),
      ...
      ::capnp::word(112, 58, 79, 112, 101, 114, 97, 116),
      ...
      ::capnp::word(177, 101, 172, 217, 26, 72, 208, 242),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(16, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 82, 101, 111, 114, 100),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 70, 108, 97, 116, 116),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 79, 112, 83, 116, 114),
      ::capnp::word(111, 110, 103, 0, 0, 0, 0, 0),
      ::capnp::word(1, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        0 => <crate::uhdm_capnp::expr::Owned as ::capnp::introspect::Introspect>::introspect(),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[6,0,5,3,4,1,2];
    pub const TYPE_ID: u64 = 0xb8f7_8b9b_bf57_5136;
  }
}
