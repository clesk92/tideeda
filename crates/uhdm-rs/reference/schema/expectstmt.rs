pub mod expectstmt {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_propertyspec(self) -> u64 {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_propertyspec(&mut self, value: u64)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 81] = [
      ...
      ::capnp::word(113, 56, 0, 0, 241, 56, 0, 0),
      ...
      ::capnp::word(112, 58, 69, 120, 112, 101, 99, 116),
    ...
    pub const TYPE_ID: u64 = 0xf3de_053b_e707_8813;
  }
}
