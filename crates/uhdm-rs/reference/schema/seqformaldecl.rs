pub mod seqformaldecl {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_namedeventsequenceexprgroup(self) -> ::capnp::Result<crate::uhdm_capnp::obj_index_type::Reader<'a>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(2), ::core::option::Option::None)
    }
    #[inline]
    pub fn has_namedeventsequenceexprgroup(&self) -> bool {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_namedeventsequenceexprgroup(self) -> ::capnp::Result<crate::uhdm_capnp::obj_index_type::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(2), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_namedeventsequenceexprgroup(&mut self, value: crate::uhdm_capnp::obj_index_type::Reader<'_>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(2), value, false)
    }
    #[inline]
    pub fn init_namedeventsequenceexprgroup(self, ) -> crate::uhdm_capnp::obj_index_type::Builder<'a> {
  ...
  impl Pipeline  {
    ...
    pub fn get_namedeventsequenceexprgroup(&self) -> crate::uhdm_capnp::obj_index_type::Pipeline {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 119] = [
      ...
      ::capnp::word(65, 70, 0, 0, 10, 71, 0, 0),
      ...
      ::capnp::word(112, 58, 83, 101, 113, 102, 111, 114),
      ::capnp::word(109, 97, 108, 100, 101, 99, 108, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(193, 0, 0, 0, 226, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[3,0,4,5,2,1];
    pub const TYPE_ID: u64 = 0xaf38_1ade_e02b_c0fe;
  }
}
