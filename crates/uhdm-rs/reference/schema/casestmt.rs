pub mod casestmt {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_vpi_rand_type(self) -> u64 {
      self.reader.get_data_field::<u64>(0)
    }
    #[inline]
    pub fn get_vpi_case_type(self) -> i64 {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_vpi_rand_type(&mut self, value: u64)  {
    ...
    #[inline]
    pub fn set_vpi_case_type(&mut self, value: i64)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 118] = [
      ...
      ::capnp::word(68, 54, 0, 0, 255, 54, 0, 0),
      ...
      ::capnp::word(112, 58, 67, 97, 115, 101, 115, 116),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 67, 97, 115, 101, 84),
      ::capnp::word(121, 112, 101, 0, 0, 0, 0, 0),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[0,5,2,4,3,1];
    pub const TYPE_ID: u64 = 0xede2_ad1c_fb1b_1a41;
  }
}
