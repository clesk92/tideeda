pub mod parameter {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 195] = [
      ...
      ::capnp::word(181, 128, 0, 0, 240, 129, 0, 0),
      ...
      ::capnp::word(112, 58, 80, 97, 114, 97, 109, 101),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[0,3,5,4,6,1,9,10,7,8,2];
    pub const TYPE_ID: u64 = 0x8a6a_dc7c_d95a_0dfb;
  }
}
