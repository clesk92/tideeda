pub mod namedevent {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_eventtypespec(self) -> u64 {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_eventtypespec(&mut self, value: u64)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 184] = [
      ...
      ::capnp::word(104, 127, 0, 0, 135, 128, 0, 0),
      ...
      ::capnp::word(112, 58, 78, 97, 109, 101, 100, 101),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(101, 118, 101, 110, 116, 116, 121, 112),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[6,0,7,8,5,1,4,9,3,2];
    pub const TYPE_ID: u64 = 0x91c0_45e5_ff30_dd47;
  }
}
