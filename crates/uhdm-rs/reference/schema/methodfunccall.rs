pub mod methodfunccall {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_function(&mut self, value: u64)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 97] = [
      ...
      ::capnp::word(203, 161, 0, 0, 94, 162, 0, 0),
      ...
      ::capnp::word(102, 117, 110, 99, 99, 97, 108, 108),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub const TYPE_ID: u64 = 0x8ca5_d26a_3439_ff7f;
  }
}
