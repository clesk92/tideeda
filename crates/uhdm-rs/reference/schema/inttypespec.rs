pub mod inttypespec {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_casttoexpr(self) -> ::capnp::Result<crate::uhdm_capnp::obj_index_type::Reader<'a>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(1), ::core::option::Option::None)
    }
    #[inline]
    pub fn has_casttoexpr(&self) -> bool {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_casttoexpr(self) -> ::capnp::Result<crate::uhdm_capnp::obj_index_type::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(1), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_casttoexpr(&mut self, value: crate::uhdm_capnp::obj_index_type::Reader<'_>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
    }
    #[inline]
    pub fn init_casttoexpr(self, ) -> crate::uhdm_capnp::obj_index_type::Builder<'a> {
  ...
  impl Pipeline  {
    ...
    pub fn get_casttoexpr(&self) -> crate::uhdm_capnp::obj_index_type::Pipeline {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 101] = [
      ...
      ::capnp::word(165, 148, 0, 0, 59, 149, 0, 0),
      ...
      ::capnp::word(112, 58, 73, 110, 116, 116, 121, 112),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(99, 97, 115, 116, 116, 111, 101, 120),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[0,2,4,3,1];
    pub const TYPE_ID: u64 = 0xbb50_cff8_6bec_e78a;
  }
}
