pub mod caseproperty {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_casepropertyitems(self) -> ::capnp::Result<::capnp::primitive_list::Reader<'a,u64>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(2), ::core::option::Option::None)
    }
    #[inline]
    pub fn has_casepropertyitems(&self) -> bool {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_casepropertyitems(self) -> ::capnp::Result<::capnp::primitive_list::Builder<'a,u64>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(2), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_casepropertyitems(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::primitive_list::Owned<u64>>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(2), value, false)
    }
    #[inline]
    pub fn init_casepropertyitems(self, size: u32) -> ::capnp::primitive_list::Builder<'a,u64> {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 71] = [
      ...
      ::capnp::word(206, 75, 0, 0, 62, 76, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(99, 97, 115, 101, 112, 114, 111, 112),
      ::capnp::word(101, 114, 116, 121, 105, 116, 101, 109),
    ...
    pub const TYPE_ID: u64 = 0x9182_1aa3_a1d4_f53b;
  }
}
