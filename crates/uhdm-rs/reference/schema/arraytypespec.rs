pub mod arraytypespec {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_vpi_array_type(self) -> i64 {
    ...
    #[inline]
    pub fn get_indextypespec(self) -> ::capnp::Result<crate::uhdm_capnp::obj_index_type::Reader<'a>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(4), ::core::option::Option::None)
    }
    #[inline]
    pub fn has_indextypespec(&self) -> bool {
    ...
    #[inline]
    pub fn get_resolutionfunc(self) -> u64 {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_vpi_array_type(&mut self, value: i64)  {
    ...
    #[inline]
    pub fn get_indextypespec(self) -> ::capnp::Result<crate::uhdm_capnp::obj_index_type::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(4), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_indextypespec(&mut self, value: crate::uhdm_capnp::obj_index_type::Reader<'_>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(4), value, false)
    }
    #[inline]
    pub fn init_indextypespec(self, ) -> crate::uhdm_capnp::obj_index_type::Builder<'a> {
    ...
    #[inline]
    pub fn set_resolutionfunc(&mut self, value: u64)  {
  ...
  impl Pipeline  {
    ...
    pub fn get_indextypespec(&self) -> crate::uhdm_capnp::obj_index_type::Pipeline {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 149] = [
      ...
      ::capnp::word(87, 154, 0, 0, 91, 155, 0, 0),
      ...
      ::capnp::word(112, 58, 65, 114, 114, 97, 121, 116),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(105, 110, 100, 101, 120, 116, 121, 112),
      ...
      ::capnp::word(111, 110, 102, 117, 110, 99, 0, 0),
      ::capnp::word(9, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[0,6,5,3,2,7,4,1];
    pub const TYPE_ID: u64 = 0x9f5b_d4d1_e571_7146;
  }
}
