pub mod foreverstmt {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 49] = [
      ...
      ::capnp::word(158, 49, 0, 0, 232, 49, 0, 0),
      ...
      ::capnp::word(112, 58, 70, 111, 114, 101, 118, 101),
      ::capnp::word(114, 115, 116, 109, 116, 0, 0, 0),
    ...
    pub const TYPE_ID: u64 = 0xaf11_1d28_0b35_39f4;
  }
}
