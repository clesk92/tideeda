pub mod taskfunc {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_vpi_method(self) -> bool {
    ...
    #[inline]
    pub fn get_vpi_d_p_i_pure(self) -> bool {
      self.reader.get_bool_field(3)
    }
    #[inline]
    pub fn get_vpi_d_p_i_context(self) -> bool {
      self.reader.get_bool_field(4)
    }
    #[inline]
    pub fn get_vpi_d_p_i_c_str(self) -> i64 {
      self.reader.get_data_field::<i64>(3)
    }
    #[inline]
    pub fn get_vpi_d_p_i_c_identifier(self) -> u64 {
      self.reader.get_data_field::<u64>(4)
    }
    #[inline]
    pub fn get_leftrange(self) -> ::capnp::Result<crate::uhdm_capnp::obj_index_type::Reader<'a>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(1), ::core::option::Option::None)
    }
    #[inline]
    pub fn has_leftrange(&self) -> bool {
      !self.reader.get_pointer_field(1).is_null()
    }
    #[inline]
    pub fn get_rightrange(self) -> ::capnp::Result<crate::uhdm_capnp::obj_index_type::Reader<'a>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(2), ::core::option::Option::None)
    }
    #[inline]
    pub fn has_rightrange(&self) -> bool {
      !self.reader.get_pointer_field(2).is_null()
    }
    #[inline]
    pub fn get_return(self) -> ::capnp::Result<crate::uhdm_capnp::obj_index_type::Reader<'a>> {
  ...
  impl <'a,> ::capnp::traits::HasStructSize for Builder<'a,>  {
    const STRUCT_SIZE: ::capnp::private::layout::StructSize = ::capnp::private::layout::StructSize { data: 6, pointers: 7 };
  }
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_vpi_method(&mut self, value: bool)  {
    ...
    #[inline]
    pub fn set_vpi_d_p_i_pure(&mut self, value: bool)  {
    ...
    #[inline]
    pub fn set_vpi_d_p_i_context(&mut self, value: bool)  {
    ...
    #[inline]
    pub fn set_vpi_d_p_i_c_str(&mut self, value: i64)  {
    ...
    #[inline]
    pub fn set_vpi_d_p_i_c_identifier(&mut self, value: u64)  {
      self.builder.set_data_field::<u64>(4, value);
    }
    #[inline]
    pub fn get_leftrange(self) -> ::capnp::Result<crate::uhdm_capnp::obj_index_type::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(1), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_leftrange(&mut self, value: crate::uhdm_capnp::obj_index_type::Reader<'_>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
    }
    #[inline]
    pub fn init_leftrange(self, ) -> crate::uhdm_capnp::obj_index_type::Builder<'a> {
    ...
    #[inline]
    pub fn get_rightrange(self) -> ::capnp::Result<crate::uhdm_capnp::obj_index_type::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(2), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_rightrange(&mut self, value: crate::uhdm_capnp::obj_index_type::Reader<'_>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(2), value, false)
    }
    #[inline]
    pub fn init_rightrange(self, ) -> crate::uhdm_capnp::obj_index_type::Builder<'a> {
    ...
    #[inline]
    pub fn get_return(self) -> ::capnp::Result<crate::uhdm_capnp::obj_index_type::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(3), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_return(&mut self, value: crate::uhdm_capnp::obj_index_type::Reader<'_>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(3), value, false)
    }
    #[inline]
    pub fn init_return(self, ) -> crate::uhdm_capnp::obj_index_type::Builder<'a> {
    ...
    #[inline]
    pub fn get_stmt(self) -> ::capnp::Result<crate::uhdm_capnp::obj_index_type::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(5), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_stmt(&mut self, value: crate::uhdm_capnp::obj_index_type::Reader<'_>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(5), value, false)
    }
    #[inline]
    pub fn init_stmt(self, ) -> crate::uhdm_capnp::obj_index_type::Builder<'a> {
  ...
  impl Pipeline  {
    ...
    pub fn get_leftrange(&self) -> crate::uhdm_capnp::obj_index_type::Pipeline {
      ::capnp::capability::FromTypelessPipeline::new(self._typeless.get_pointer_field(1))
    }
    pub fn get_rightrange(&self) -> crate::uhdm_capnp::obj_index_type::Pipeline {
      ::capnp::capability::FromTypelessPipeline::new(self._typeless.get_pointer_field(2))
    }
    pub fn get_return(&self) -> crate::uhdm_capnp::obj_index_type::Pipeline {
      ::capnp::capability::FromTypelessPipeline::new(self._typeless.get_pointer_field(3))
    }
    pub fn get_stmt(&self) -> crate::uhdm_capnp::obj_index_type::Pipeline {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 292] = [
      ...
      ::capnp::word(112, 58, 84, 97, 115, 107, 102, 117),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 77, 101, 116, 104, 111),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 68, 80, 73, 80, 117),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 68, 80, 73, 67, 111),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 68, 80, 73, 67, 83),
      ::capnp::word(116, 114, 0, 0, 0, 0, 0, 0),
      ::capnp::word(5, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 68, 80, 73, 67, 73),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(108, 101, 102, 116, 114, 97, 110, 103),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(114, 105, 103, 104, 116, 114, 97, 110),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(115, 116, 109, 116, 0, 0, 0, 0),
      ::capnp::word(16, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(91, 83, 69, 32, 250, 22, 98, 182),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        ...
        15 => <crate::uhdm_capnp::obj_index_type::Owned as ::capnp::introspect::Introspect>::introspect(),
        16 => <crate::uhdm_capnp::obj_index_type::Owned as ::capnp::introspect::Introspect>::introspect(),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[0,13,16,14,10,12,11,15,2,5,9,8,7,6,1,4,3];
    pub const TYPE_ID: u64 = 0x9c37_05d8_b626_1fcf;
  }
}
