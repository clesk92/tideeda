pub mod primterm {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_vpi_term_index(self) -> i64 {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_vpi_term_index(&mut self, value: i64)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 117] = [
      ...
      ::capnp::word(175, 118, 0, 0, 90, 119, 0, 0),
      ...
      ::capnp::word(112, 58, 80, 114, 105, 109, 116, 101),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 84, 101, 114, 109, 73),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[4,0,5,1,2,3];
    pub const TYPE_ID: u64 = 0xec0e_3017_6f5c_8354;
  }
}
