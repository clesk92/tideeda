pub mod netloads {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 34] = [
      ...
      ::capnp::word(112, 58, 78, 101, 116, 108, 111, 97),
    ...
    pub const TYPE_ID: u64 = 0xd96f_92de_7983_3b02;
  }
}
