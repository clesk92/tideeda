pub mod tfcall {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_tfcallargs(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,crate::uhdm_capnp::obj_index_type::Owned>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(2), ::core::option::Option::None)
    }
    #[inline]
    pub fn has_tfcallargs(&self) -> bool {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_tfcallargs(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,crate::uhdm_capnp::obj_index_type::Owned>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(2), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_tfcallargs(&mut self, value: ::capnp::struct_list::Reader<'_,crate::uhdm_capnp::obj_index_type::Owned>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(2), value, false)
    }
    #[inline]
    pub fn init_tfcallargs(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::uhdm_capnp::obj_index_type::Owned> {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 84] = [
      ...
      ::capnp::word(85, 160, 0, 0, 207, 160, 0, 0),
      ...
      ::capnp::word(112, 58, 84, 102, 99, 97, 108, 108),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(116, 102, 99, 97, 108, 108, 97, 114),
    ...
    pub const TYPE_ID: u64 = 0xb7e6_5306_9c49_6409;
  }
}
