pub mod tchkterm {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_vpi_edge(&mut self, value: i64)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 80] = [
      ...
      ::capnp::word(161, 119, 0, 0, 19, 120, 0, 0),
      ...
      ::capnp::word(112, 58, 84, 99, 104, 107, 116, 101),
      ::capnp::word(114, 109, 0, 0, 0, 0, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 69, 100, 103, 101, 0),
    ...
    pub const TYPE_ID: u64 = 0xce96_0fe9_5119_1a58;
  }
}
