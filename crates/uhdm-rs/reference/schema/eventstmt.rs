pub mod eventstmt {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_namedevent(self) -> u64 {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_namedevent(&mut self, value: u64)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 66] = [
      ...
      ::capnp::word(24, 49, 0, 0, 118, 49, 0, 0),
      ...
      ::capnp::word(112, 58, 69, 118, 101, 110, 116, 115),
    ...
    pub const TYPE_ID: u64 = 0xac4b_e3d3_3973_bf92;
  }
}
