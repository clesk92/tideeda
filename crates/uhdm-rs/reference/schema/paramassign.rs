pub mod paramassign {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_vpi_overriden(self) -> bool {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_vpi_overriden(&mut self, value: bool)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 116] = [
      ...
      ::capnp::word(234, 113, 0, 0, 151, 114, 0, 0),
      ...
      ::capnp::word(112, 58, 80, 97, 114, 97, 109, 97),
      ::capnp::word(115, 115, 105, 103, 110, 0, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 79, 118, 101, 114, 114),
      ::capnp::word(105, 100, 101, 110, 0, 0, 0, 0),
      ::capnp::word(1, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[5,0,4,3,1,2];
    pub const TYPE_ID: u64 = 0xba53_9a52_fdf9_f899;
  }
}
