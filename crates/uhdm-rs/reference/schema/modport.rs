pub mod modport {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_interfaceinst(self) -> u64 {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_interfaceinst(&mut self, value: u64)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 84] = [
      ...
      ::capnp::word(52, 99, 0, 0, 167, 99, 0, 0),
      ...
      ::capnp::word(112, 58, 77, 111, 100, 112, 111, 114),
      ...
      ::capnp::word(101, 105, 110, 115, 116, 0, 0, 0),
      ::capnp::word(9, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub const TYPE_ID: u64 = 0xb4ee_a6df_5a3c_b40c;
  }
}
