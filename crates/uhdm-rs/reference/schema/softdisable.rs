pub mod softdisable {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 49] = [
      ...
      ::capnp::word(237, 168, 0, 0, 56, 169, 0, 0),
      ...
      ::capnp::word(112, 58, 83, 111, 102, 116, 100, 105),
      ::capnp::word(115, 97, 98, 108, 101, 0, 0, 0),
    ...
    pub const TYPE_ID: u64 = 0xefd7_4360_2e54_3307;
  }
}
