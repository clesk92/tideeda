pub mod immediateassert {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_vpi_is_deferred(self) -> i64 {
      self.reader.get_data_field::<i64>(0)
    }
    #[inline]
    pub fn get_vpi_is_final(self) -> i64 {
    ...
    #[inline]
    pub fn get_elsestmt(self) -> ::capnp::Result<crate::uhdm_capnp::obj_index_type::Reader<'a>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(3), ::core::option::Option::None)
    }
    #[inline]
    pub fn has_elsestmt(&self) -> bool {
      !self.reader.get_pointer_field(3).is_null()
    }
    #[inline]
    pub fn get_clockingblock(self) -> u64 {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_vpi_is_deferred(&mut self, value: i64)  {
    ...
    #[inline]
    pub fn set_vpi_is_final(&mut self, value: i64)  {
    ...
    #[inline]
    pub fn get_elsestmt(self) -> ::capnp::Result<crate::uhdm_capnp::obj_index_type::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(3), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_elsestmt(&mut self, value: crate::uhdm_capnp::obj_index_type::Reader<'_>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(3), value, false)
    }
    #[inline]
    pub fn init_elsestmt(self, ) -> crate::uhdm_capnp::obj_index_type::Builder<'a> {
    ...
    #[inline]
    pub fn set_clockingblock(&mut self, value: u64)  {
  ...
  impl Pipeline  {
    ...
    pub fn get_elsestmt(&self) -> crate::uhdm_capnp::obj_index_type::Pipeline {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 129] = [
      ...
      ::capnp::word(125, 63, 0, 0, 82, 64, 0, 0),
      ...
      ::capnp::word(112, 58, 73, 109, 109, 101, 100, 105),
      ::capnp::word(97, 116, 101, 97, 115, 115, 101, 114),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 73, 115, 68, 101, 102),
      ::capnp::word(101, 114, 114, 101, 100, 0, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(118, 112, 105, 73, 115, 70, 105, 110),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(101, 108, 115, 101, 115, 116, 109, 116),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(16, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(91, 83, 69, 32, 250, 22, 98, 182),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[0,6,5,3,4,1,2];
    pub const TYPE_ID: u64 = 0x8a3d_f10b_d99c_fd21;
  }
}
